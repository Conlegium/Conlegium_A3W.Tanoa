...
private ["_planeChoices", "_convoyVeh", "_veh1", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_numWaypoints", "_reward", "_reward2"];
...
_setupObjects =
{
	...
	_missionHintText = format ["A<br/><t color='%2'>%1</t><br/>is patrolling the island. Intercept it and recover its cargo!!", _vehicleName, moneyMissionColor];
